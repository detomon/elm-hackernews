...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.bm, request.M, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aM: fragment, aN: host, aQ: path, aS: port_, aV: protocol, aW: query};
	});
...
var $author$project$HackerNews$ItemPlaceholder = function (a) {
	return {$: 0, a: a};
};
var $tomjkidd$elm_multiway_tree_zipper$MultiwayTree$Tree = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$HackerNews$emptyComments = A2(
	$tomjkidd$elm_multiway_tree_zipper$MultiwayTree$Tree,
	$author$project$HackerNews$ItemPlaceholder(0),
	_List_Nil);
var $author$project$HackerNews$empty = function (itemsPerPage) {
	return {Q: _List_Nil, B: $author$project$HackerNews$emptyComments, an: $elm$core$Maybe$Nothing, F: $elm$core$Dict$empty, S: itemsPerPage, ag: 0, H: _List_Nil};
};
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {w: frag, z: params, v: unvisited, q: value, A: visited};
	});
...
var $author$project$Main$PageRoute = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Main$routes = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2($elm$url$Url$Parser$map, $author$project$Main$PageHome, $elm$url$Url$Parser$top),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Main$PageRoute,
			A2(
				$elm$url$Url$Parser$slash,
				$elm$url$Url$Parser$s('page'),
				$elm$url$Url$Parser$int))
		]));
var $author$project$HackerNews$GotItem = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
...
var $author$project$HackerNews$ItemJob = function (a) {
	return {$: 3, a: a};
};
var $author$project$HackerNews$ItemStory = function (a) {
	return {$: 1, a: a};
};
var $author$project$HackerNews$Job = F6(
	function (by, id, score, time, title, url) {
		return {am: by, E: id, a0: score, aB: time, a5: title, M: url};
	});
...
var $author$project$HackerNews$decodeItemWithType = function (type_) {
	var timeFromInt = A2(
	...
	switch (type_) {
		case 'story':
			return A2(
				$elm$json$Json$Decode$map,
				$author$project$HackerNews$ItemStory,
				A4(
									...
									A3(
										...
										A3(
											...
											A3(
												...
												'by',
												$elm$json$Json$Decode$string,
												$elm$json$Json$Decode$succeed($author$project$HackerNews$Story))))))))));
		case 'comment':
			return A2(
				$elm$json$Json$Decode$map,
				$author$project$HackerNews$ItemComment,
				A4(
					$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
					'deleted',
								...
								A4(
									...
									A3(
										...
										A4(
											...
											$elm$json$Json$Decode$string,
											'',
											$elm$json$Json$Decode$succeed($author$project$HackerNews$Comment)))))))));
		case 'job':
			return A2(
				$elm$json$Json$Decode$map,
				$author$project$HackerNews$ItemJob,
				A4(
					$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
					'url',
					A2($elm$json$Json$Decode$map, $elm$core$Maybe$Just, $elm$json$Json$Decode$string),
							...
							A3(
								...
								A3(
									...
									A3(
										...
										'by',
										$elm$json$Json$Decode$string,
										$elm$json$Json$Decode$succeed($author$project$HackerNews$Job))))))));
		default:
			return $elm$json$Json$Decode$fail('Unknown type \'' + (type_ + '\''));
	}
};
...
var $author$project$HackerNews$httpTimeout = 60 * 1000;
var $elm$http$Http$Request = function (a) {
	return {$: 1, a: a};
};
var $elm$http$Http$State = F2(
	function (reqs, subs) {
		return {aY: reqs, a3: subs};
	});
...
var $author$project$HackerNews$itemId = function (item) {
	switch (item.$) {
		case 0:
			var id = item.a;
			return id;
...
var $author$project$HackerNews$apiUrl = 'https://hacker-news.firebaseio.com/v0';
var $author$project$HackerNews$itemUrl = function (id) {
	return $author$project$HackerNews$apiUrl + ('/item/' + ($elm$core$String$fromInt(id) + '.json'));
};
...
var $author$project$HackerNews$fetchItems = F2(
	function (itemIds, model) {
		var isPlaceholder = function (item) {
			if (!item.$) {
				return true;
			} else {
				return false;
		...
		var decodeItem = A2(
			...
			$author$project$HackerNews$decodeItemWithType,
		...
		var fetchList = A2(
			...
			$elm$core$List$map(
				function (id) {
					return A2(
						fetchItem,
						$author$project$HackerNews$GotItem(id),
						id);
				}),
			A2($elm$core$Basics$composeR, $elm$core$List$reverse, $elm$core$Platform$Cmd$batch));
		var cachedOrPlaceholderItem = function (id) {
			return A2(
				$elm$core$Maybe$withDefault,
				$author$project$HackerNews$ItemPlaceholder(id),
				A2($elm$core$Dict$get, id, model.F));
		};
		var itemList = A2($elm$core$List$map, cachedOrPlaceholderItem, itemIds);
		var missingItemIds = A2(
			$elm$core$List$map,
			$author$project$HackerNews$itemId,
			A2($elm$core$List$filter, isPlaceholder, itemList));
		var cmd = fetchList(missingItemIds);
		return _Utils_Tuple2(itemList, cmd);
	});
...
var $author$project$HackerNews$paging = F2(
	function (itemsPerPage, page) {
		return A2(
			$elm$core$Basics$composeR,
			$elm$core$List$drop(itemsPerPage * page),
			$elm$core$List$take(itemsPerPage));
	});
var $author$project$HackerNews$setPage = F2(
	function (page, model) {
		var newPage = A2($elm$core$Basics$max, 0, page);
		var pagedItemsIds = A3($author$project$HackerNews$paging, model.S, newPage, model.Q);
		var _v0 = A2($author$project$HackerNews$fetchItems, pagedItemsIds, model);
		var pagedItems = _v0.a;
		var cmd = _v0.b;
		var newModel = _Utils_update(
			model,
			{ag: newPage, H: pagedItems});
		return _Utils_Tuple2(newModel, cmd);
	});
var $author$project$Main$HackerNewsMsg = function (a) {
	return {$: 3, a: a};
};
var $elm$core$Platform$Cmd$map = _Platform_map;
var $author$project$Main$updateHackernews = F2(
	function (model, _v0) {
		var hackernews = _v0.a;
		var cmd = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{j: hackernews}),
			A2($elm$core$Platform$Cmd$map, $author$project$Main$HackerNewsMsg, cmd));
	});
var $author$project$Main$handleUrl = F2(
	function (url, model) {
		var handleRoute = function (route) {
			if (!route.$) {
				return A2(
					$author$project$Main$updateHackernews,
					model,
					A2($author$project$HackerNews$setPage, 0, model.j));
			} else {
				var page = route.a;
				return A2(
					$author$project$Main$updateHackernews,
					model,
					A2($author$project$HackerNews$setPage, page - 1, model.j));
			}
		};
		var _v0 = A2(
			$elm$core$Maybe$withDefault,
			...
			A2(
				$elm$core$Maybe$map,
				handleRoute,
				A2($elm$url$Url$Parser$parse, $author$project$Main$routes, url)));
		var newModel = _v0.a;
		var cmd = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
...
var $author$project$Main$itemsPerPage = 30;
var $elm$time$Time$utc = A2($elm$time$Time$Zone, 0, _List_Nil);
var $author$project$Main$init = F3(
	function (flags, url, key) {
		var model = {
			j: $author$project$HackerNews$empty($author$project$Main$itemsPerPage),
			aq: key,
			ai: false,
			aC: $elm$time$Time$utc,
			a5: 'Hacker News',
			M: url
		};
		var _v0 = A2($author$project$Main$handleUrl, url, model);
		var newModel = _v0.a;
		var cmd = _v0.b;
		return _Utils_Tuple2(
			newModel,
...
var $author$project$HackerNews$fetchChildren = F2(
	function (parentId, model) {
		var parent = A2(
			$elm$core$Maybe$withDefault,
			$author$project$HackerNews$ItemPlaceholder(0),
			A2($elm$core$Dict$get, parentId, model.F));
		var fetchChild = function (child) {
			var _v0 = A2(
				$author$project$HackerNews$fetchItems,
				$author$project$HackerNews$itemKids(child),
				model);
			var children = _v0.a;
			var subCmd = _v0.b;
			var _v1 = $elm$core$List$unzip(
				A2($elm$core$List$map, fetchChild, children));
			var treeChildren = _v1.a;
			var childCmds = _v1.b;
			var cmds = A2($elm$core$List$cons, subCmd, childCmds);
			return _Utils_Tuple2(
				A2($tomjkidd$elm_multiway_tree_zipper$MultiwayTree$Tree, child, treeChildren),
				$elm$core$Platform$Cmd$batch(cmds));
		};
		var _v2 = fetchChild(parent);
		var comments = _v2.a;
		var cmdList = _v2.b;
		return _Utils_Tuple2(
			_Utils_update(
...
var $author$project$HackerNews$GotTopStories = function (a) {
	return {$: 0, a: a};
};
var $author$project$HackerNews$topStoriesUrl = $author$project$HackerNews$apiUrl + '/topstories.json';
var $author$project$HackerNews$fetchTopStories = function () {
...
var $tomjkidd$elm_multiway_tree_zipper$MultiwayTree$filter = F2(
	function (predicate, _v0) {
		var d = _v0.a;
		var c = _v0.b;
		return predicate(d) ? $elm$core$Maybe$Just(
			A2(
				$tomjkidd$elm_multiway_tree_zipper$MultiwayTree$Tree,
				d,
				A2(
					$elm$core$List$filterMap,
					$tomjkidd$elm_multiway_tree_zipper$MultiwayTree$filter(predicate),
					c))) : $elm$core$Maybe$Nothing;
	});
var $tomjkidd$elm_multiway_tree_zipper$MultiwayTree$map = F2(
	function (fn, _v0) {
		var d = _v0.a;
		var c = _v0.b;
		var mappedDatum = fn(d);
		var mappedChildren = A2(
			$elm$core$List$map,
			function (child) {
				return A2($tomjkidd$elm_multiway_tree_zipper$MultiwayTree$map, fn, child);
			},
			c);
		return A2($tomjkidd$elm_multiway_tree_zipper$MultiwayTree$Tree, mappedDatum, mappedChildren);
	});
var $elm$core$Basics$not = _Basics_not;
var $author$project$MultiwayTree$Extra$replace = F2(
	function (fn, tree) {
		var datum = tree.a;
		var children = tree.b;
		var _v0 = fn(tree);
...
var $author$project$HackerNews$update = F2(
	function (msg, model) {
				...
				_Utils_update(
					model,
					{
						an: $elm$core$Maybe$Just(
							$author$project$HackerNews$resultErrorString(err))
					}),
				$elm$core$Platform$Cmd$none);
		};
		var placeholderId = function (item) {
			if (!item.$) {
				var id = item.a;
		...
		var replacePlaceholder = F3(
			function (map, id, newItem) {
				return map(
					function (item) {
						return _Utils_eq(
							placeholderId(item),
							$elm$core$Maybe$Just(id)) ? newItem : item;
					});
			});
		if (!msg.$) {
			var result = msg.a;
			if (!result.$) {
				var ids = result.a;
				return A2(
					$author$project$HackerNews$setPage,
					model.ag,
					_Utils_update(
						model,
						{Q: ids}));
			...
			if (!result.$) {
				...
				var newModel = _Utils_update(
					...
					{
						B: A2(
							$author$project$MultiwayTree$Extra$replace,
							addChildren,
							A2(
								$elm$core$Maybe$withDefault,
								$author$project$HackerNews$emptyComments,
								A2(
									$tomjkidd$elm_multiway_tree_zipper$MultiwayTree$filter,
									isNotDeleted,
									A4(replacePlaceholder, $tomjkidd$elm_multiway_tree_zipper$MultiwayTree$map, id, item, model.B)))),
						F: A3($elm$core$Dict$insert, id, item, model.F),
						H: A4(replacePlaceholder, $elm$core$List$map, id, item, model.H)
					});
				var _v3 = function () {
					if (item.$ === 2) {
						return A2(
							$author$project$HackerNews$fetchItems,
							$author$project$HackerNews$itemKids(item),
							newModel);
					} else {
						return _Utils_Tuple2(_List_Nil, $elm$core$Platform$Cmd$none);
					}
				}();
				var loadChildren = _v3.b;
				return _Utils_Tuple2(newModel, loadChildren);
			} else {
				var err = result.a;
				return setError(err);
			}
...
var $author$project$Main$update = F2(
	function (msg, model) {
		...
		switch (msg.$) {
			case 2:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{aC: timeZone}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$HackerNewsMsg, $author$project$HackerNews$fetchTopStories));
			case 3:
				var submsg = msg.a;
				return A2(
					$author$project$Main$updateHackernews,
					model,
					A2($author$project$HackerNews$update, submsg, model.j));
			case 4:
				var page = msg.a;
				return A2(
					$author$project$Main$updateHackernews,
					model,
					A2($author$project$HackerNews$setPage, page, model.j));
			case 5:
				var itemId = msg.a;
				return A2(
					...
					A2(
						$author$project$Main$updateHackernews,
						model,
						A2($author$project$HackerNews$fetchChildren, itemId, model.j)));
			case 6:
				return _Utils_Tuple2(
					A2(setShowComments, false, model),
					$elm$core$Platform$Cmd$none);
			case 7:
				var keyCode = msg.a;
			...
			default:
				var url = msg.a;
				return A2($author$project$Main$handleUrl, url, model);
		}
	});
var $author$project$Main$HideComments = {$: 6};
var $elm$html$Html$a = _VirtualDom_node('a');
var $elm$html$Html$button = _VirtualDom_node('button');
var $tomjkidd$elm_multiway_tree_zipper$MultiwayTree$children = function (_v0) {
	var d = _v0.a;
	var c = _v0.b;
	return c;
};
...
var $author$project$HackerNews$currentComments = function (_v0) {
	var comments = _v0.B;
	return comments;
};
var $author$project$HackerNews$currentItems = function (_v0) {
	var pagedItems = _v0.H;
	return pagedItems;
};
...
var $author$project$Main$nodeIf = F4(
	function (name, attrs, children, flag) {
		return flag ? A3($elm$html$Html$node, name, attrs, children) : $elm$html$Html$text('');
	});
...
var $author$project$HackerNews$pageUrl = 'https://news.ycombinator.com';
var $author$project$HackerNews$pagesCount = function (model) {
	return ((($elm$core$List$length(model.Q) + model.S) - 1) / model.S) | 0;
};
...
var $author$project$Main$ShowComments = function (a) {
	return {$: 5, a: a};
};
...
var $pablohirafuji$elm_markdown$Markdown$Config$defaultOptions = {
	bu: $pablohirafuji$elm_markdown$Markdown$Config$Sanitize($pablohirafuji$elm_markdown$Markdown$Config$defaultSanitizeOptions),
	a2: false
};
var $author$project$Main$markdownOptions = function () {
	var options = $pablohirafuji$elm_markdown$Markdown$Config$defaultOptions;
	return $elm$core$Maybe$Just(
		_Utils_update(
			options,
			{bu: $pablohirafuji$elm_markdown$Markdown$Config$ParseUnsafe}));
}();
var $author$project$Main$nobreakSpace = '\u00A0';
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {bj: index, bl: match, bp: number, bA: submatches};
	});
		...
		if (!asts.b) {
			return _List_fromArray(
				[
					_List_fromArray(
					[
						$pablohirafuji$elm_markdown$Markdown$Block$BlankLine(match.bl)
					])
				]);
		} else {
			var ast = asts.a;
						...
						return _Utils_eq(listBlock.R, model.R) ? function (a) {
							...
							A2(
								...
								_Utils_update(
									...
									{
										i: listBlock.i,
										s: model.s || $pablohirafuji$elm_markdown$Markdown$Block$isBlankLineLast(items)
									}),
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$initParser = F3(
	function (options, refs, rawText) {
		return {a: _List_Nil, G: options, l: rawText, ax: refs, d: _List_Nil};
	});
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$matchToInline = function (_v0) {
	...
	switch (_v1.$) {
		...
		case 2:
			return $pablohirafuji$elm_markdown$Markdown$Inline$CodeInline(match.bC);
		case 3:
			var _v2 = _v1.a;
			var text = _v2.a;
			var url = _v2.b;
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$prepareChildMatch = F2(
	function (parentMatch, childMatch) {
		return _Utils_update(
			childMatch,
			{aK: childMatch.aK - parentMatch.o, az: childMatch.az - parentMatch.o, L: childMatch.L - parentMatch.o, o: childMatch.o - parentMatch.o});
	});
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$organizeMatch = F2(
	function (_v0, matches) {
		...
		if (!matches.b) {
			...
			return (_Utils_cmp(prevMatch.aK, match.az) < 1) ? A2($elm$core$List$cons, match, matches) : (((_Utils_cmp(prevMatch.az, match.az) < 0) && (_Utils_cmp(prevMatch.aK, match.aK) > 0)) ? A2(
				$elm$core$List$cons,
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$parseTextMatch = F3(
	function (rawText, _v2, parsedMatches) {
		...
		var updtMatch = _Utils_update(
			matchModel,
			{
				a: A3($pablohirafuji$elm_markdown$Markdown$InlineParser$parseTextMatches, matchModel.bC, _List_Nil, matchModel.a)
			});
		if (!parsedMatches.b) {
			var finalStr = A2($elm$core$String$dropLeft, matchModel.aK, rawText);
			...
			return _Utils_eq(matchHead.Y, $pablohirafuji$elm_markdown$Markdown$InlineParser$NormalType) ? A2($elm$core$List$cons, updtMatch, parsedMatches) : (_Utils_eq(matchModel.aK, matchHead.az) ? A2($elm$core$List$cons, updtMatch, parsedMatches) : ((_Utils_cmp(matchModel.aK, matchHead.az) < 0) ? A2(
				...
				A2(
					...
					$pablohirafuji$elm_markdown$Markdown$InlineParser$normalMatch(
						A3($elm$core$String$slice, matchModel.aK, matchHead.az, rawText)),
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$parseText = function (model) {
	return _Utils_update(
		model,
		{
			a: A3($pablohirafuji$elm_markdown$Markdown$InlineParser$parseTextMatches, model.l, _List_Nil, model.a)
		});
};
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$regMatchToAngleBracketLToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $pablohirafuji$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{
				bj: regMatch.bj + backslashesLength,
				b: 1,
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$regMatchToEmphasisToken = F3(
	function (_char, rawText, regMatch) {
		...
		if ((((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.a.$)) && _v0.b.b.b.b) {
			...
			var mLeftFringe = ((!(!regMatch.bj)) && (!leftFringeLength)) ? $elm$core$Maybe$Just(
				A3($elm$core$String$slice, regMatch.bj - 1, regMatch.bj, rawText)) : maybeLeftFringe;
			var backslashesLength = A2(
				$elm$core$Maybe$withDefault,
				0,
				A2($elm$core$Maybe$map, $elm$core$String$length, maybeBackslashes));
			...
			var index = ((regMatch.bj + backslashesLength) + leftFringeLength) + (isEscaped ? 1 : 0);
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				return (!$pablohirafuji$elm_markdown$Markdown$Helpers$isEven(backslashesLength)) ? $elm$core$Maybe$Just(
					{bj: (regMatch.bj + backslashesLength) - 1, b: 2, c: $pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Nothing;
			} else {
				if (_v0.b.b && (!_v0.b.a.$)) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
						{
							bj: regMatch.bj,
							b: $elm$core$String$length(regMatch.bl),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				var backslashesLength = $elm$core$String$length(backslashes);
				return $pablohirafuji$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
					{bj: regMatch.bj + backslashesLength, b: 1, c: $pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Just(
					{bj: (regMatch.bj + backslashesLength) - 1, b: 2, c: $pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken});
			} else {
				if (_v0.b.b) {
					var _v1 = _v0.b;
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$regMatchToLinkImageOpenToken = function (regMatch) {
	...
	if (((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.a.$)) {
		...
		var index = (regMatch.bj + backslashesLength) + ((isEscaped && _Utils_eq(
			maybeImageOpen,
	...
	return _Utils_update(
		model,
		{
			d: A2(
				...
				_Utils_ap(
					$pablohirafuji$elm_markdown$Markdown$InlineParser$findAngleBracketRTokens(model.l),
					_Utils_ap(
						$pablohirafuji$elm_markdown$Markdown$InlineParser$findAngleBracketLTokens(model.l),
						_Utils_ap(
							A2($pablohirafuji$elm_markdown$Markdown$InlineParser$findHardBreakTokens, model.G.a2, model.l),
							_Utils_ap(
								$pablohirafuji$elm_markdown$Markdown$InlineParser$findLinkImageCloseTokens(model.l),
								_Utils_ap(
									$pablohirafuji$elm_markdown$Markdown$InlineParser$findLinkImageOpenTokens(model.l),
									_Utils_ap(
										$pablohirafuji$elm_markdown$Markdown$InlineParser$findUnderlineEmphasisTokens(model.l),
										_Utils_ap(
											$pablohirafuji$elm_markdown$Markdown$InlineParser$findAsteriskEmphasisTokens(model.l),
											$pablohirafuji$elm_markdown$Markdown$InlineParser$findCodeTokens(model.l)))))))))
		});
};
	...
	A2(
		...
		function (match) {
			return A2(
				$elm$core$Maybe$withDefault,
				match.bl,
				$elm$url$Url$percentDecode(match.bl));
		}));
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$autolinkToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $pablohirafuji$elm_markdown$Markdown$InlineParser$urlRegex, match.bC) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$refRegexToMatch = F3(
	function (matchModel, model, maybeRegexMatch) {
		...
		var refLabel = function (str) {
			return $elm$core$String$isEmpty(str) ? matchModel.bC : str;
		}(
			A2(
				$elm$core$Maybe$withDefault,
				matchModel.bC,
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$checkParsedAheadOverlapping = function (parser) {
	...
	if (!_v0.b) {
		...
		var overlappingMatches = A2(
			...
			function (_v1) {
				var testMatch = _v1;
				return (_Utils_cmp(match.aK, testMatch.az) > 0) && (_Utils_cmp(match.aK, testMatch.aK) < 0);
			},
			remainMatches);
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$emailAutolinkTypeToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $pablohirafuji$elm_markdown$Markdown$InlineParser$emailRegex, match.bC) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				Y: $pablohirafuji$elm_markdown$Markdown$InlineParser$AutolinkType(
	...
	function (model, _v0) {
		...
		if (_v1.$ === 2) {
			...
			return A2(
				...
				$elm$core$List$head(
					A3($elm$regex$Regex$findAtMost, 1, $pablohirafuji$elm_markdown$Markdown$InlineParser$htmlRegex, match.bC)));
		}
	});
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$lineBreakTTM = function (_v0) {
	...
	while (true) {
		...
		if (!tokens.b) {
			...
			if (_Utils_eq(token.c, $pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken) || (_Utils_eq(token.c, $pablohirafuji$elm_markdown$Markdown$InlineParser$SoftLineBreakToken) && model.G.a2)) {
		...
		if (!_v0.b) {
			...
			return _Utils_Tuple2(
				A2(
					$elm$core$List$filter,
					function (token) {
						return _Utils_cmp(token.bj, match.aK) > -1;
					},
					tokensTail),
				parser);
		}
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$codeToMatch = F3(
	function (closeToken, model, _v20) {
		...
		var updtOpenToken = _Utils_eq(
			...
			openToken,
			{bj: openToken.bj + 1, b: openToken.b - 1}) : openToken;
		return _Utils_update(
			model,
			{
				a: A2(
	...
	function (closeToken, tokensTail, model, _v15) {
		...
		var updt = (!remainLength) ? {ab: closeToken, U: openToken, ah: remainTokens, aj: tokensTail} : ((remainLength > 0) ? {
			...
			aj: A2(
				...
				_Utils_update(
					closeToken,
					{bj: closeToken.bj + openToken.b, b: -remainLength}),
				tokensTail)
		});
		var match = A6(
			$pablohirafuji$elm_markdown$Markdown$InlineParser$tokenPairToMatch,
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$linkOrImageTypeToMatch = F4(
	function (closeToken, tokensTail, model, _v1) {
		...
		var remainText = A2($elm$core$String$dropLeft, closeToken.bj + 1, model.l);
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$tokenPairToMatch = F6(
	function (model, processText, type_, openToken, closeToken, innerTokens) {
		var textStart = openToken.bj + openToken.b;
		var textEnd = closeToken.bj;
		var start = openToken.bj;
		var end = closeToken.bj + closeToken.b;
		var match = {
			aK: end,
			a: _List_Nil,
			az: start,
				...
				return A2(
					...
					function (a) {
						...
						A2(
							...
							A2($pablohirafuji$elm_markdown$Markdown$Block$parseInlines, maybeOptions, model.s),
							function (b) {
...
var $pablohirafuji$elm_markdown$Markdown$Block$insertLinkMatch = F2(
	function (refs, linkMatch) {
		return A2($elm$core$Dict$member, linkMatch.x, refs) ? refs : A3(
			$elm$core$Dict$insert,
			linkMatch.x,
			_Utils_Tuple2(linkMatch.M, linkMatch.at),
			refs);
	});
var $pablohirafuji$elm_markdown$Markdown$Block$extractUrlTitleRegex = function (regexMatch) {
	...
	if ((((((_v0.b && (!_v0.a.$)) && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) && _v0.b.b.b.b.b.b) {
		...
		var toReturn = function (rawUrl) {
			return {
				x: rawText,
				as: $elm$core$String$length(regexMatch.bl),
...
var $pablohirafuji$elm_markdown$Markdown$Block$maybeLinkMatch = function (rawText) {
	return A2(
		$elm$core$Maybe$andThen,
		function (linkMatch) {
			return ((linkMatch.M === '') || (linkMatch.x === '')) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(linkMatch);
		},
		A2(
			$elm$core$Maybe$map,
			function (linkMatch) {
				return _Utils_update(
					linkMatch,
					{
						x: $pablohirafuji$elm_markdown$Markdown$Helpers$prepareRefLabel(linkMatch.x)
					});
			},
			A2(
				$elm$core$Maybe$andThen,
...
var $author$project$Main$viewPostTitle = function (_v0) {
	...
	var titleNode = A2(
		$elm$core$Maybe$withDefault,
		textNode,
		A2($elm$core$Maybe$map, link, href));
	return A2(
		$elm$html$Html$li,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('post-info')
					]),
				info)
			]));
};
var $author$project$Main$viewPost = function (post) {
	switch (post.$) {
			...
			return $author$project$Main$viewPostTitle(
				{
					...
					a5: $author$project$Main$nobreakSpace
				});
		case 1:
			var story = post.a;
			var text = $elm$core$String$fromInt(story.a0) + (' points by ' + (story.am + ' | '));
			var comments = $elm$core$String$fromInt(story.bd) + ' comments';
			var info = _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('#comments'),
							$elm$html$Html$Events$onClick(
							$author$project$Main$ShowComments(story.E))
						]),
					_List_fromArray(
						[
		...
		case 2:
			...
			var markdown = A2($pablohirafuji$elm_markdown$Markdown$toHtml, $author$project$Main$markdownOptions, text);
			var info = _List_fromArray(
				[
					$elm$html$Html$text('by ' + (comment.am + ' | '))
				]);
			var header = A2(
				$elm$html$Html$span,
				_List_fromArray(
			...
			return A2(
				...
				A2($elm$core$List$cons, header, markdown));
		default:
			var job = post.a;
...
var $author$project$Main$viewComments = function (children) {
	var post = F2(
		function (i, n) {
			return A2(
				$elm$html$Html$li,
				...
				_List_fromArray(
					[
						$author$project$Main$viewPost(i),
						($elm$core$List$length(n) > 0) ? $author$project$Main$viewComments(n) : $elm$html$Html$text('')
					]));
		});
	var keyedTree = function (_v0) {
		var child = _v0.a;
		var subchildren = _v0.b;
		return _Utils_Tuple2(
			$elm$core$String$fromInt(
				$author$project$HackerNews$itemId(child)),
			A3($elm$html$Html$Lazy$lazy2, post, child, subchildren));
	};
	var posts = A2($elm$core$List$map, keyedTree, children);
	return A3(
...
var $author$project$Main$viewError = function (error) {
	var text = A2($elm$core$Maybe$withDefault, '', error);
	return A4(
		$author$project$Main$nodeIf,
		'div',
		_List_fromArray(
			[
		...
		!_Utils_eq(error, $elm$core$Maybe$Nothing));
};
var $author$project$Main$keyedItem = function (item) {
	return _Utils_Tuple2(
		$elm$core$String$fromInt(
			$author$project$HackerNews$itemId(item)),
		A2($elm$html$Html$Lazy$lazy, $author$project$Main$viewPost, item));
};
var $author$project$Main$viewItems = F2(
		...
		return A3(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$start(start)
				]),
			A2($elm$core$List$map, $author$project$Main$keyedItem, items));
	});
...
var $author$project$Main$pageUrl = function (page) {
	return '/page/' + $elm$core$String$fromInt(page + 1);
};
var $author$project$Main$viewPaging = F2(
	function (count, page) {
		var listItem = function (n) {
			return A2(
				$elm$html$Html$li,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('paging__page'),
		...
		var pages = A2($elm_community$list_extra$List$Extra$initialize, count, listItem);
		return A2(
			$elm$html$Html$ul,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('paging')
				]),
			pages);
	});
var $author$project$Main$view = function (model) {
	var pagesCount = $author$project$HackerNews$pagesCount(model.j);
	var items = $author$project$HackerNews$currentItems(model.j);
	var itemStart = (model.j.ag * $author$project$Main$itemsPerPage) + 1;
	var comment = $tomjkidd$elm_multiway_tree_zipper$MultiwayTree$children(
		$author$project$HackerNews$currentComments(model.j));
	return {
		ba: _List_fromArray(
			[
				A3(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$href('/assets/base.css')
					]),
				_List_Nil),
				A2(
				$elm$html$Html$div,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href($author$project$HackerNews$pageUrl),
										$elm$html$Html$Attributes$rel('noreferrer')
									]),
								_List_fromArray(
									[
						...
						A2($elm$html$Html$Lazy$lazy, $author$project$Main$viewError, model.j.an),
						A3($elm$html$Html$Lazy$lazy2, $author$project$Main$viewItems, items, itemStart),
						A3($elm$html$Html$Lazy$lazy2, $author$project$Main$viewPaging, pagesCount, model.j.ag),
						A4(
						$author$project$Main$nodeIf,
						'div',
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('comments-wrapper')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('comments-content')
									]),
								_List_fromArray(
									[
										A2($elm$html$Html$Lazy$lazy, $author$project$Main$viewComments, comment)
									])),
								A2(
								$elm$html$Html$button,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('comments-close'),
										$elm$html$Html$Events$onClick($author$project$Main$HideComments)
									]),
								_List_fromArray(
									[
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{bk: $author$project$Main$init, bq: $author$project$Main$UrlChange, br: $author$project$Main$UrlRequest, bB: $author$project$Main$subscriptions, bF: $author$project$Main$update, bG: $author$project$Main$view});
